...
exports.Group = exports.Shape = exports.Scope = exports.Option = exports.Input = exports.Model = exports.TrimlNode = void 0;
...
exports.Scope = Scope;
class Shape extends TrimlNode {
    toJsonNode() {
        var _a, _b, _c, _d, _e;
        const jsonNode = (0, TrimlJson_1.trimlToJsonNode)(this);
        jsonNode.nodeType = "shape";
        if (this.name)
            (_a = jsonNode.properties) === null || _a === void 0 ? void 0 : _a.push(new TrimlJson_1.TrimlJsonProperty("name", this.name));
        if (this.type)
            (_b = jsonNode.properties) === null || _b === void 0 ? void 0 : _b.push(new TrimlJson_1.TrimlJsonProperty("type", this.type));
        if (this.label)
            (_c = jsonNode.properties) === null || _c === void 0 ? void 0 : _c.push(new TrimlJson_1.TrimlJsonProperty("label", this.label));
        if (this.source)
            (_d = jsonNode.properties) === null || _d === void 0 ? void 0 : _d.push(new TrimlJson_1.TrimlJsonProperty("source", this.source));
        if (this.data)
            (_e = jsonNode.properties) === null || _e === void 0 ? void 0 : _e.push(new TrimlJson_1.TrimlJsonProperty("data", this.data));
        return jsonNode;
    }
}
exports.Shape = Shape;
class Group extends TrimlNode {
    toJsonNode() {
        var _a, _b;
        const jsonNode = (0, TrimlJson_1.trimlToJsonNode)(this);
        ...
        if (this.name)
            (_a = jsonNode.properties) === null || _a === void 0 ? void 0 : _a.push(new TrimlJson_1.TrimlJsonProperty("name", this.name));
        if (this.condition)
            (_b = jsonNode.properties) === null || _b === void 0 ? void 0 : _b.push(new TrimlJson_1.TrimlJsonProperty("condition", this.condition));
        return jsonNode;
    }
}
exports.Group = Group;
