...
class Shape extends TrimlNode {
    toJsonNode() {
        ...
        if (this.type)
            (_a = jsonNode.properties) === null || _a === void 0 ? void 0 : _a.push(new TrimlJson_1.TrimlJsonProperty("type", this.type));
        if (this.data)
            (_b = jsonNode.properties) === null || _b === void 0 ? void 0 : _b.push(new TrimlJson_1.TrimlJsonProperty("data", this.data));
        return jsonNode;
    }
}
exports.Shape = Shape;
